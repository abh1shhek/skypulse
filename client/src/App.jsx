...
export default function App() {
  const { flights, news, selectedId, loading, query, error, nav, followed, fetchFlights, fetchNews, setSelected, tick, sidebarOpen, setSidebarOpen, toggleFollow, setNav, clearFollowed } = useFlightStore()
